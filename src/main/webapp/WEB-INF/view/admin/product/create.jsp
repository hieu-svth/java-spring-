                                        ...
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form method="post" action="/admin/product/create" class="row"
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:input type="text" class="form-control ${not empty errorDetailDesc ? 'is-invalid' : ''}" 
                                                    path="shortDesc" />
                                                    ${errorshortDesc}
                                                </div>
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:input type="number" class="form-control ${not empty errorDetailDesc ? 'is-invalid' : ''}" 
                                                    path="quantity" />
                                                    ${errorQuantity}
                                                </div>
